...
exports.generateResponse = exports.updateHotel = exports.deleteHotel = exports.createHotel = exports.getHotelById = exports.getAllHotels = void 0;
const Hotel_1 = __importDefault(require("../infrastructure/schemas/Hotel"));
const not_found_error_1 = __importDefault(require("../domian/errors/not-found-error"));
const validation_error_1 = __importDefault(require("../domian/errors/validation-error"));
const hotel_1 = require("../domian/dtos/hotel");
...
const createHotel = async (req, res, next) => {
    try {
        ...
        const sharedId = new mongoose_1.default.Types.ObjectId();
        //Add hotel
        ...
        const embeddingsModel = new openai_2.OpenAIEmbeddings({
...
const updateHotel = async (req, res, next) => {
    try {
        const hotelId = req.params.id;
        //Validate the request
        const updatedHotel = hotel_1.CreateHotelDTO.safeParse(req.body);
        //Validate the request
        if (!updatedHotel.success) {
            throw new validation_error_1.default(updatedHotel.error.message);
        }
        //update hotel
